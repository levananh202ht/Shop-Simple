...
export const BoxProduct = ({item}) => {
    ...
    return (
        ...
        <div className="px-8 pt-4">
            <p className="text-gray-500 text-[14px] font-medium overflow-hidden display-webkit-box webkit-box-orient-vertical webkit-line-clamp-1 text-ellipsis">{category}</p>
            <Link
