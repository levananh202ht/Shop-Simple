...
export const AllListProduct = () => {
    ...
    const children = (
        ...
        <FormControlLabel
            label="groceries"
            control={<Checkbox checked={checked[1]} onChange={handleChangeGroceries} />}
        />
        <FormControlLabel
            label="home-decoration"
            control={<Checkbox checked={checked[1]} onChange={handleChangeDecoration} />}
        />
        <FormControlLabel
            label="skincare"
            control={<Checkbox checked={checked[1]} onChange={handleChangeSkincare} />}
        />
        <FormControlLabel
            label="laptops"
            control={<Checkbox checked={checked[1]} onChange={handleChangeLaptops} />}
        />
        </Box>
    );
