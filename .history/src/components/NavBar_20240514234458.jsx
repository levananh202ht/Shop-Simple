...
export default function NavBar() {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
        <CssBaseline />
        <AppBar position="fixed" open={open} className='px-36 py-2 !bg-white flex justify-between  '>
            <Toolbar className='!flex justify-between'>
                ...
                <div className='text-black font-semibold text-xl flex '>
                    <div className='gap-5'>
                    {
                        ...
                        className={({ isActive }) =>
                            isActive ? "border-solid border-amber-300 border-b-2 mx-auto py-1 flex gap-5" : ""
                        } 
                        key={index}  
