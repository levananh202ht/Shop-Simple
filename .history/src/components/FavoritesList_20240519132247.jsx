...
import { addToCart, removeFromWish } from "../redux/feature/cartSlice"
...
export const FavoritesList = ({item}) => {
    ...
    return (
        ...
        <div className="flex items-center justify-between px-8 pb-4">
            ...
            <AiFillDelete onClick={() => dispatch(removeFromWish(id))} className="text-xl text-red-600 cursor-pointer" />
        </div>
        <button
            type="button"
