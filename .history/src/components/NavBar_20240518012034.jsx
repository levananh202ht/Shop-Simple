...
export default function NavBar() {
    ...
    return (
        ...
        <AppBar position="fixed" open={open} className='px-36 py-2 !bg-white  '>
            <Toolbar className='flex justify-between'>
                ...
                <div className='flex gap-6'>
                    <LoginPopup className="flex items-center justify-center"/>
                    <IconButton
                        color="inherit"
                        ...
                        <div className='absolute top-0 flex items-center justify-center w-5 h-5 bg-red-600 rounded-full -right-3'>
                            <p className='text-sm font-normal text-white '>{listCarts.length}</p>
                        </div>
                    </IconButton>
                </div>
        ...
        >
            ...
            >
                <BsCart2 />
                <div className="absolute flex items-center justify-center w-5 h-5 bg-red-600 rounded-full -top-1 -right-3">
                <b className="text-sm text-white">{listCarts.length}</b>
                </div>
            </IconButton>
            </DrawerHeader>
            <Divider  />
