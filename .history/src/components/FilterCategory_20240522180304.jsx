...
export default function FilterCategory({}) {
    ...
    let listProduct = useSelector((state) => state.productSlice.listProduct)
    console.log(listProduct,"listProductm123");
    ...
    if (sortBy === 'priceLowToHigh') {
        filteredProducts = listProduct.slice().sort((a, b) => a.price - b.price);
    } else if (sortBy === 'priceHighToLow') {
        filteredProducts = listProduct.slice().sort((a, b) => b.price - a.price);
    }
