            ...
            <div className=''>
              ...
              >
                ...
                <div>
                  ...
                  />
                  {formSubmitted && !fromData.phone && (
                    <span className="ml-5 text-red-500">* Phone is required</span>
                  )}
                </div>
                <div>
                  <TextField
                    ...
                    maxRows={4}
                  />
                  {formSubmitted && !fromData.address && (
                    <span className="ml-5 text-red-500">* Address is required</span>
                  )}
                </div>
              </Box>
            </div>
              ...
              <TableBody>
                {listCarts.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <AiFillDelete onClick={() => handleDelete(row.id)} className="text-xl text-red-600 cursor-pointer" />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
