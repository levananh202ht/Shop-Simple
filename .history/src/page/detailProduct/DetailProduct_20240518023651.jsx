...
export const DetailProduct = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 gap-3 px-4 md:grid-cols-2 lg:grid-cols-3 font-karla">
            ...
            <div className="mt-2">
                ...
                <p className="leading-5">{detaiProduct.description}</p>
            </div>
            <div className="flex items-center space-x-1">
                <SlMinus
                    onClick={() => dispath(reduceFromCart(detaiProduct.id))}
                    className="cursor-pointer"
                />
                <span className="font-semibold">{detaiProduct.quantity}</span>
                <SlPlus
                    className="cursor-pointer"
                    onClick={() => handleUpdateAddToCart(detaiProduct)}
                />
            </div>
            ...
            <div class="space-y-2">Reviews</div>
            {["Nghiêm", "Đức", "Hải", "Minh", "Hằng"].map((item,index) => (
                <div key={item} class="leading-4 py-3">
                <h3 class="font-semibold text-md">{item}</h3>
                <div class="flex items-center text-[#ffb21d]">
                    <RatingStar rating={index + 1} />
                    <span class="ml-2 text-gray-600 font-semibold">{index + 1}</span>
                </div>
                <p class="text-sm leading-4">
                    The product is nice. I got the delivery on time. I am using it
                    for the last four months. My exprience with this product is very
                    good.
                </p>
                </div>
            ))}
