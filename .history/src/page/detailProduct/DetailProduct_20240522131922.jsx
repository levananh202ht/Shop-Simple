...
import { AddWishlist } from "../../redux/feature/wishSlice";
import { ListProduct, SaleListProduct } from "../../redux/feature/productSlice";
...
export const DetailProduct = () => {
    ...
    const loadData = async () => {
        ...
        dispatch(SaleListProduct(products.slice(10,18)));
    }
    ...
    const listProduct = useSelector((state) => state.productSlice.SaleListProduct)
    useEffect(() => {
        loadData()
        listProduct
        if (idProduct) {
                ...
                <h2 className="text-4xl font-semibold text-green-700"> Trending Products</h2>
                    <div className="grid gap-6 mt-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {listProduct.map((item) => (
                            <ListOtherProducts key={item.id} item={item} />
                        ))}
                    </div>
                </div>
            {/* <ListOtherProducts listProduct={listProduct}  /> */}
