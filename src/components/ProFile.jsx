                ...
                <div>
                    ...
                    <div>
                        <div>
                            ...
                            <div className='flex'>
                                <div className='mr-20'>
                                    <p className='w-36'>09/2021 - Present</p>
                                </div>
                                <div>
                        ...
                        <div>
                            <h1 className='w-20 mb-4 text-xl font-semibold border-b-2 border-gray-900'>SKILLS</h1>
                            <div>
                                <div className='flex'>
                                    <div className='mr-20 w-36'>
                                        <p>Languages </p>
                                    </div>
                                    <div>
                                ...
                                <div className='flex'>
                                    ...
                                    <div>
                                        <h3 className='w-[550px]'>Visual Studio Code, Github, Postman, Read and understand documents in English, ability to work independently and research ability. </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
